...
st.pyplot(fig)
# -------- EXPLANATION BLOCK --------
st.subheader("📖 Model & SHAP Explanation")

st.markdown("""
### 🤖 Machine Learning Models

**🔹 Linear Regression**
- Assumes a linear relationship between pollutants and AQI  
- Easy to understand and fast  
- Works well for simple patterns  

**🔹 Decision Tree**
- Splits data into conditions (if-else rules)  
...
**🔹 Global Explanation**
- Shows which pollutants impact AQI the most overall  
- Example: PM2.5 usually has highest impact  

**🔹 Local Explanation**
- Explains a single prediction  
- Shows how each pollutant increases or decreases AQI  

---

### 🌫 Real Insight

- High **PM2.5 & PM10** → major increase in AQI  
- Gases like **NO2, SO2, CO** also contribute  
- Clean cities have lower pollutant concentrations  
...
✔ SHAP makes the model transparent  
✔ Helps in real-world decision making (pollution control)
""")
